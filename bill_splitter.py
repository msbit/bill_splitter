...
class Period:
	...
	def __str__(self):
		return str(self.start_date) + ' ' + str(self.end_date) + ' ' + str(self.tenants)
...
for period in periods:
	period_share = ((period.end_date - period.start_date).days * total_amount) / (total_period * len(period.tenants))
